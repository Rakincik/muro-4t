...
{
    /// <inheritdoc />
    public partial class LiveAndVideoFeatures : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WrongPenaltyWeight = table.Column<double>(type: "double precision", nullable: false),
                    PdfUrl = table.Column<string>(type: "text", nullable: true),
                    SolutionPdfUrl = table.Column<string>(type: "text", nullable: true),
                    AnswerKeyJson = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Podcasts_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BbbMeetingId = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VideoNotes_MediaAssets_MediaAssetId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VideoProgresses_MediaAssets_MediaAssetId",
                        column: x => x.MediaAssetId,
                        principalTable: "MediaAssets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SessionRecordings_MediaAssets_MediaAssetId",
                        column: x => x.MediaAssetId,
                        principalTable: "MediaAssets",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseGroups_CourseId_GroupId",
                table: "CourseGroups",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionRecordings_MediaAssetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoNotes_MediaAssetId",
                table: "VideoNotes",
                column: "MediaAssetId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoProgresses_MediaAssetId",
                table: "VideoProgresses",
                column: "MediaAssetId");

            migrationBuilder.CreateIndex(
                name: "IX_VideoProgresses_UserId_MediaAssetId",
                table: "VideoProgresses",
